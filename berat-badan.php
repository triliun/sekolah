...
<form method="post" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
    ...
    <label class="relative text-gray-400 focus-within:text-gray-600 block mb-2">
      ...
      <input type="number" name="a" placeholder="Masukan berat badan" required class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </label>
    </div>
<?php
$a = '';
