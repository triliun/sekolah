...
function hasil($angka, $text){
 echo '<button class="bg-indigo-600 rounded-md w-full mt-3 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">'. "#$angka $text". "</button>";
};
}
?>
<!DOCTYPE html>
...
<form method="post" class="bg-white rounded px-8 mb-4">
    ...
    <label class="relative text-gray-400 focus-within:text-gray-600 block mb-2">
      ...
      <input type="number" name="nomor" placeholder="Masukan Angka" id="nomor" required class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </label>
    <label class="relative text-gray-400 focus-within:text-gray-600 block mb-2">
      ...
      <input type="text" name="kalimat" placeholder="Masukan kalimat" id="kalimat" required class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </label>

    </div>
<button type="submit" name="hasil" class="bg-indigo-500 rounded-md w-full mt-3 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">Hasil</button>
</form>
